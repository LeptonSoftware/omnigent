...
def _register(store: HostStore, host_id: str, name: str, user_id: str) -> Host:
    ...
    """
    return store.upsert_on_connect(host_id=host_id, name=name, user_id=user_id)
...
def test_grants_follow_host_id_rotation(host_store: HostStore) -> None:
    ...
    rotated = host_store.upsert_on_connect(host_id=HOST_B, name="alice-laptop", user_id=ALICE)
